      ...
      <section className="border-t border-fl-line bg-fl-ivory">
        <div className="mx-auto grid max-w-5xl gap-10 px-5 py-16 text-center sm:grid-cols-3 sm:px-8 sm:py-20 sm:text-left">
          <div>
            ...
            <p className="mt-3 font-sans text-sm leading-relaxed text-fl-ink-muted">
              15-needle heads, hand-inspected, run against an approved production standard on
              every order.
            </p>
          </div>
          <div>
            ...
            <p className="mt-3 font-sans text-sm leading-relaxed text-fl-ink-muted">
              We would rather place one mark well than cover a garment. Quiet is a design choice.
            </p>
          </div>
          <div>
            <h2 className="font-serif text-xl text-fl-charcoal">Partnership</h2>
            <p className="mt-3 font-sans text-sm leading-relaxed text-fl-ink-muted">
              Institutional programs, corporate accounts, and personal commissions are each held
              to the same standard, at the scale each one needs.
            </p>
          </div>
        </div>
      </section>
