...
export const metadata: Metadata = {
  title: "Monogram Atelier — Fine Ligne Studio",
...
export default function MonogramAtelierPage() {
  ...
  return (
    <CategoryDetail
      category={category}
      intro="Three initials. One family crest. A robe for someone who has everything. The atelier is where Fine Ligne Studio slows down for a single, personal commission."
      visual={
